...
On macOS, the same view expands and contracts with its containing window and places close and new-conversation actions in the native toolbar. You can also embed ``ChatbotView`` directly in a window, navigation destination, tab, or split-view detail.
